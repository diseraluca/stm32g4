///Reader of register DAC_STMODR
pub type R = crate::R<u32, super::DAC_STMODR>;
///Writer for register DAC_STMODR
...
///Reader of field `STRSTTRIGSEL1`
pub type STRSTTRIGSEL1_R = crate::R<u8, u8>;
///Write proxy for field `STRSTTRIGSEL1`
...
///Reader of field `STINCTRIGSEL1`
pub type STINCTRIGSEL1_R = crate::R<u8, u8>;
///Write proxy for field `STINCTRIGSEL1`
...
///Write proxy for field `STRSTTRIGSEL2`
...
///Reader of field `STINCTRIGSEL2`
pub type STINCTRIGSEL2_R = crate::R<u8, u8>;
///Write proxy for field `STINCTRIGSEL2`
