...
///This register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).
///
///For information about available fields see [sec2r](sec2r) module
pub type SEC2R = crate::Reg<u32, _SEC2R>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SEC2R;
///`read()` method returns [sec2r::R](sec2r::R) reader structure
impl crate::Readable for SEC2R {}
///`write(|w| ..)` method takes [sec2r::W](sec2r::W) writer structure
impl crate::Writable for SEC2R {}
///Flash Securable area bank2 register
pub mod sec2r;
