...
///Reader of field `EM33`
pub type EM33_R = crate::R<bool, EM32_A>;
///Write proxy for field `EM33`
pub struct EM33_W<'a> {
    w: &'a mut W,
}
impl<'a> EM33_W<'a> {
...
///Reader of field `EM35`
pub type EM35_R = crate::R<bool, EM32_A>;
///Write proxy for field `EM35`
pub struct EM35_W<'a> {
    w: &'a mut W,
}
impl<'a> EM35_W<'a> {
...
///Reader of field `EM36`
pub type EM36_R = crate::R<bool, EM32_A>;
///Write proxy for field `EM36`
pub struct EM36_W<'a> {
    w: &'a mut W,
}
impl<'a> EM36_W<'a> {
...
///Reader of field `EM37`
pub type EM37_R = crate::R<bool, EM32_A>;
///Write proxy for field `EM37`
pub struct EM37_W<'a> {
    w: &'a mut W,
}
impl<'a> EM37_W<'a> {
...
///Reader of field `EM40`
pub type EM40_R = crate::R<bool, EM32_A>;
///Write proxy for field `EM40`
pub struct EM40_W<'a> {
    w: &'a mut W,
}
impl<'a> EM40_W<'a> {
...
///Reader of field `EM41`
pub type EM41_R = crate::R<bool, EM32_A>;
///Write proxy for field `EM41`
pub struct EM41_W<'a> {
    w: &'a mut W,
}
impl<'a> EM41_W<'a> {
...
///Reader of field `EM42`
pub type EM42_R = crate::R<bool, EM32_A>;
///Write proxy for field `EM42`
pub struct EM42_W<'a> {
    w: &'a mut W,
}
impl<'a> EM42_W<'a> {
...
///Reader of field `EM43`
pub type EM43_R = crate::R<bool, EM32_A>;
///Write proxy for field `EM43`
pub struct EM43_W<'a> {
    w: &'a mut W,
}
impl<'a> EM43_W<'a> {
