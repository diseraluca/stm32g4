///Reader of register RXF0S
pub type R = crate::R<u32, super::RXF0S>;
///Writer for register RXF0S
...
///Reader of field `F0FL`
pub type F0FL_R = crate::R<u8, u8>;
///Write proxy for field `F0FL`
pub struct F0FL_W<'a> {
    w: &'a mut W,
}
impl<'a> F0FL_W<'a> {
...
///Reader of field `F0GI`
pub type F0GI_R = crate::R<u8, u8>;
///Write proxy for field `F0GI`
pub struct F0GI_W<'a> {
    w: &'a mut W,
}
impl<'a> F0GI_W<'a> {
...
///Reader of field `F0PI`
pub type F0PI_R = crate::R<u8, u8>;
///Write proxy for field `F0PI`
pub struct F0PI_W<'a> {
    w: &'a mut W,
}
impl<'a> F0PI_W<'a> {
