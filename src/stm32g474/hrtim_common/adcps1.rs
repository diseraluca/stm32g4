///Reader of register ADCPS1
pub type R = crate::R<u32, super::ADCPS1>;
///Writer for register ADCPS1
...
///Reader of field `ADC5PSC`
pub type ADC5PSC_R = crate::R<u8, u8>;
///Write proxy for field `ADC5PSC`
...
///Reader of field `ADC4PSC`
pub type ADC4PSC_R = crate::R<u8, u8>;
///Write proxy for field `ADC4PSC`
...
///Reader of field `ADC3PSC`
pub type ADC3PSC_R = crate::R<u8, u8>;
///Write proxy for field `ADC3PSC`
...
///Reader of field `ADC2PSC`
pub type ADC2PSC_R = crate::R<u8, u8>;
///Write proxy for field `ADC2PSC`
...
///Reader of field `ADC1PSC`
pub type ADC1PSC_R = crate::R<u8, u8>;
///Write proxy for field `ADC1PSC`
