///Reader of register ADCPS2
pub type R = crate::R<u32, super::ADCPS2>;
///Writer for register ADCPS2
...
///Reader of field `ADC10PSC`
pub type ADC10PSC_R = crate::R<u8, u8>;
///Write proxy for field `ADC10PSC`
...
///Reader of field `ADC9PSC`
pub type ADC9PSC_R = crate::R<u8, u8>;
///Write proxy for field `ADC9PSC`
...
///Reader of field `ADC8PSC`
pub type ADC8PSC_R = crate::R<u8, u8>;
///Write proxy for field `ADC8PSC`
...
///Reader of field `ADC7PSC`
pub type ADC7PSC_R = crate::R<u8, u8>;
///Write proxy for field `ADC7PSC`
...
///Reader of field `ADC6PSC`
pub type ADC6PSC_R = crate::R<u8, u8>;
///Write proxy for field `ADC6PSC`
