///Reader of register BMCR
pub type R = crate::R<u32, super::BMCR>;
///Writer for register BMCR
...
///Reader of field `BMSTAT`
pub type BMSTAT_R = crate::R<bool, bool>;
///Write proxy for field `BMSTAT`
...
///Reader of field `TFBM`
pub type TFBM_R = crate::R<bool, bool>;
///Write proxy for field `TFBM`
pub struct TFBM_W<'a> {
    w: &'a mut W,
}
impl<'a> TFBM_W<'a> {
...
///Reader of field `TEBM`
pub type TEBM_R = crate::R<bool, bool>;
///Write proxy for field `TEBM`
pub struct TEBM_W<'a> {
    w: &'a mut W,
}
impl<'a> TEBM_W<'a> {
...
///Reader of field `TDBM`
pub type TDBM_R = crate::R<bool, bool>;
///Write proxy for field `TDBM`
pub struct TDBM_W<'a> {
    w: &'a mut W,
}
impl<'a> TDBM_W<'a> {
...
///Reader of field `TCBM`
pub type TCBM_R = crate::R<bool, bool>;
///Write proxy for field `TCBM`
pub struct TCBM_W<'a> {
    w: &'a mut W,
}
impl<'a> TCBM_W<'a> {
...
///Reader of field `TBBM`
pub type TBBM_R = crate::R<bool, bool>;
///Write proxy for field `TBBM`
pub struct TBBM_W<'a> {
    w: &'a mut W,
}
impl<'a> TBBM_W<'a> {
...
///Reader of field `TABM`
pub type TABM_R = crate::R<bool, bool>;
///Write proxy for field `TABM`
pub struct TABM_W<'a> {
    w: &'a mut W,
}
impl<'a> TABM_W<'a> {
...
///Reader of field `MTBM`
pub type MTBM_R = crate::R<bool, bool>;
///Write proxy for field `MTBM`
pub struct MTBM_W<'a> {
    w: &'a mut W,
}
impl<'a> MTBM_W<'a> {
...
///Reader of field `BMPREN`
pub type BMPREN_R = crate::R<bool, bool>;
///Write proxy for field `BMPREN`
...
///Reader of field `BMPRSC`
pub type BMPRSC_R = crate::R<u8, u8>;
///Write proxy for field `BMPRSC`
...
///Reader of field `BMCLK`
pub type BMCLK_R = crate::R<u8, u8>;
///Write proxy for field `BMCLK`
...
///Reader of field `BMOM`
pub type BMOM_R = crate::R<bool, bool>;
///Write proxy for field `BMOM`
pub struct BMOM_W<'a> {
    w: &'a mut W,
}
impl<'a> BMOM_W<'a> {
