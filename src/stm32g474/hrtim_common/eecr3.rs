///Reader of register EECR3
pub type R = crate::R<u32, super::EECR3>;
///Writer for register EECR3
...
///Reader of field `EE6F`
pub type EE6F_R = crate::R<u8, u8>;
///Write proxy for field `EE6F`
pub struct EE6F_W<'a> {
    w: &'a mut W,
}
impl<'a> EE6F_W<'a> {
...
///Reader of field `EE7F`
pub type EE7F_R = crate::R<u8, u8>;
///Write proxy for field `EE7F`
pub struct EE7F_W<'a> {
    w: &'a mut W,
}
impl<'a> EE7F_W<'a> {
...
///Reader of field `EE8F`
pub type EE8F_R = crate::R<u8, u8>;
///Write proxy for field `EE8F`
pub struct EE8F_W<'a> {
    w: &'a mut W,
}
impl<'a> EE8F_W<'a> {
...
///Reader of field `EE9F`
pub type EE9F_R = crate::R<u8, u8>;
///Write proxy for field `EE9F`
pub struct EE9F_W<'a> {
    w: &'a mut W,
}
impl<'a> EE9F_W<'a> {
...
///Reader of field `EE10F`
pub type EE10F_R = crate::R<u8, u8>;
///Write proxy for field `EE10F`
...
///Reader of field `EEVSD`
pub type EEVSD_R = crate::R<u8, u8>;
///Write proxy for field `EEVSD`
