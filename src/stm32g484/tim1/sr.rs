...
///Reader of field `TERRF`
pub type TERRF_R = crate::R<bool, bool>;
///Write proxy for field `TERRF`
...
///Reader of field `IERRF`
pub type IERRF_R = crate::R<bool, bool>;
///Write proxy for field `IERRF`
...
///Reader of field `DIRF`
pub type DIRF_R = crate::R<bool, bool>;
///Write proxy for field `DIRF`
pub struct DIRF_W<'a> {
    w: &'a mut W,
}
impl<'a> DIRF_W<'a> {
...
///Reader of field `IDXF`
pub type IDXF_R = crate::R<bool, bool>;
///Write proxy for field `IDXF`
pub struct IDXF_W<'a> {
    w: &'a mut W,
}
impl<'a> IDXF_W<'a> {
